...
var Tabs = (function () {
    function Tabs(chrome) {
        ...
        this.tabs = [];
        this.currentId = 0;
        this.create = jasmine.createSpy("Tabs.create").and.callFake(function (props, cb) {
        ...
        this.remove = jasmine.createSpy("Tabs.remove").and.callFake(function (ids, cb) {
            _this.chrome.runtime.lastError = undefined;
        ...
        this.get = jasmine.createSpy("Tabs.get").and.callFake(function (tabId, callback) {
            _this.chrome.runtime.lastError = undefined;
            callback(_this.tabs.filter(function (tab) { return tab.id == tabId; })[0]);
        });
        this.executeScript = jasmine.createSpy("Tabs.executeScript").and.callFake(function (tabId, details, cb) {
            _this.chrome.runtime.lastError = undefined;
